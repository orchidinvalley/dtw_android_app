...
import com.dtw_asr.audio.AudioDataSaver;
import com.dtw_asr.audio.PlaybackThread;
...
public class Demo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activeTimes = 0;
        recordingThread = new RecordingThread(handle, new AudioDataSaver(),Demo.this);
